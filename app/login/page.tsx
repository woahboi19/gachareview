    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="glass-panel animate-fade-in" style={{ padding: '3rem', maxWidth: '450px', width: '100%', textAlign: 'center' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Gacha Review'e Giriş Yap</h1>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem' }}>Hikayeni değerlendir ve gacha dünyasına katıl.</p>
        </div>
        ...
        <div style={{ marginTop: '2rem', fontSize: '0.9rem', color: 'var(--color-text-muted)' }}>
          <p>Giriş yaparak kullanım koşullarını kabul etmiş olursunuz.</p>
